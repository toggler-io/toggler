...
func (o *IsFeatureEnabledOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/rollout/is-feature-enabled.json][%d] isFeatureEnabledOK  %+v", 200, o.Payload)
}
...
func (o *IsFeatureEnabledBadRequest) Error() string {
	return fmt.Sprintf("[GET /api/v1/rollout/is-feature-enabled.json][%d] isFeatureEnabledBadRequest  %+v", 400, o.Payload)
}
...
func (o *IsFeatureEnabledInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/v1/rollout/is-feature-enabled.json][%d] isFeatureEnabledInternalServerError  %+v", 500, o.Payload)
}

...
func (o *RolloutClientConfigOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/rollout/config.json][%d] rolloutClientConfigOK  %+v", 200, o.Payload)
}
...
func (o *RolloutClientConfigBadRequest) Error() string {
	return fmt.Sprintf("[GET /api/v1/rollout/config.json][%d] rolloutClientConfigBadRequest  %+v", 400, o.Payload)
}
...
func (o *RolloutClientConfigInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/v1/rollout/config.json][%d] rolloutClientConfigInternalServerError  %+v", 500, o.Payload)
}
